...
const categoryData = {
  ...
  'jewelry': {
    ...
    description: 'Exquisite necklaces, bangles and earrings to sparkle on every occasion',
    image: '/jewelry.jpg',
    filter: 'Jewelry'
  }
};
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
              ...
              <span className="text-gray-500 text-xs md:text-sm whitespace-nowrap">
                {products.filter(p => category.filter === 'All' ? true : p.category === category.filter).length} products
              </span>
            </div>
