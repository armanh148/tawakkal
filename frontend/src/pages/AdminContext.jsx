...
export const AdminProvider = ({ children }) => {
  ...
  const deleteGalleryImage = async (id) => {
    try {
      await fetchWithAuth(`/product-images/${id}/`, { method: 'DELETE' });
      loadData();
    } catch (e) {}
  };

  /* ── Order actions ── */  const updateOrderStatus = async (id, status) => {
    try {
  ...
  return (
    <AdminCtx.Provider value={{
      products, createProduct, updateProduct, toggleProductActive, deleteProduct, deleteGalleryImage,
