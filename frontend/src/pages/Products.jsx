...
const sortOptions = ['Featured', 'Price: Low to High', 'Price: High to Low', 'Newest', 'Best Seller'];
...
const Products = () => {
  ...
  const [activeSort, setActiveSort] = useState(initialSort && sortOptions.includes(initialSort) ? initialSort : 'Featured');
